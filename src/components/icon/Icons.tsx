...
export const Icons: Record<IconName, IconSrc> = {
  ...
  HeadphoneMute: (filled) =>
    filled ? (
      <>
        <path
          d="M6.30762 7.11816C5.18136 8.43019 4.5 10.1353 4.5 12V13H10V21H3V12C3 9.72099 3.84765 7.64033 5.24414 6.05469L6.30762 7.11816Z"
          fill="currentColor"
        />
        <path d="M20.1895 21H14V14.8105L20.1895 21Z" fill="currentColor" />
        <path
          d="M12 3C16.9706 3 21 7.02944 21 12V18.2754L15.7246 13H19.5V12C19.5 7.85786 16.1421 4.5 12 4.5C10.6283 4.5 9.34351 4.8697 8.2373 5.5127L7.14648 4.42188C8.54711 3.52296 10.2121 3 12 3Z"
          fill="currentColor"
        />
        <path
          d="M2.67371 4.89856L3.73437 3.8379L21.0585 21.162L19.9978 22.2227L2.67371 4.89856Z"
          fill="currentColor"
        />
      </>
    ) : (
      <>
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M6.30762 7.11816C5.18136 8.43019 4.5 10.1353 4.5 12V13H10V21H3V12C3 9.72099 3.84765 7.64033 5.24414 6.05469L6.30762 7.11816ZM4.5 19.5H8.5V14.5H4.5V19.5Z"
          fill="currentColor"
        />
        <path
          d="M15.5 16.3105V19.5H18.6895L20.1895 21H14V14.8105L15.5 16.3105Z"
          fill="currentColor"
        />
        <path
          d="M12 3C16.9706 3 21 7.02944 21 12V18.2754L19.5 16.7754V14.5H17.2246L15.7246 13H19.5V12C19.5 7.85786 16.1421 4.5 12 4.5C10.6283 4.5 9.34351 4.8697 8.2373 5.5127L7.14648 4.42188C8.54711 3.52296 10.2121 3 12 3Z"
          fill="currentColor"
        />
        <path
          d="M2.67371 4.89868L3.73437 3.83802L21.0585 21.1621L19.9978 22.2228L2.67371 4.89868Z"
          fill="currentColor"
        />
      </>
    ),
  ...
  Mic: (filled) =>
    filled ? (
      <>
        <path
          d="M12 18.5C8.41015 18.5 5.5 15.5899 5.5 12H4C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12H18.5C18.5 15.5899 15.5899 18.5 12 18.5Z"
          fill="currentColor"
        />
        <rect x="11" y="19" width="2" height="3" fill="currentColor" />
        <path
          d="M8 6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12V6Z"
          fill="currentColor"
        />
      </>
    ) : (
      <>
        <path
          d="M14.5 12V6C14.5 4.61929 13.3807 3.5 12 3.5C10.6193 3.5 9.5 4.61929 9.5 6V12C9.5 13.3807 10.6193 14.5 12 14.5V16C9.85996 16 8.11211 14.3194 8.00488 12.2061L8 12V6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V12C16 14.2091 14.2091 16 12 16V14.5C13.3807 14.5 14.5 13.3807 14.5 12Z"
          fill="currentColor"
        />
        <path
          d="M12 18.5C8.41015 18.5 5.5 15.5899 5.5 12H4C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12H18.5C18.5 15.5899 15.5899 18.5 12 18.5Z"
  ...
  MicMute: (filled) =>
    filled ? (
      <>
        <rect x="11" y="19" width="2" height="3" fill="currentColor" />
        <path
          d="M14.668 14.9785C13.96 15.6131 13.0255 16 12 16C9.79086 16 8 14.2091 8 12V8.31055L14.668 14.9785Z"
          fill="currentColor"
        />
        <path
          d="M12 2C14.2091 2 16 3.79086 16 6V12C16 12.2427 15.977 12.4801 15.9355 12.7109L8.14746 4.92285C8.61782 3.237 10.1641 2 12 2Z"
          fill="currentColor"
        />
        <path
          d="M5.5 12C5.5 15.5899 8.41015 18.5 12 18.5C13.7159 18.5 15.2748 17.8333 16.4365 16.7471L17.4971 17.8076C16.0635 19.165 14.1301 20 12 20C7.58172 20 4 16.4183 4 12H5.5Z"
          fill="currentColor"
        />
        <path
          d="M20 12C20 13.3797 19.6501 14.6776 19.0352 15.8105L17.916 14.6914C18.2898 13.8711 18.5 12.9603 18.5 12H20Z"
          fill="currentColor"
        />
        <path
          d="M3.73438 5.45947L4.79504 4.39881L20.3514 19.9552L19.2907 21.0158L3.73438 5.45947Z"
          fill="currentColor"
        />
      </>
    ) : (
      <>
        <rect x="11" y="19" width="2" height="3" fill="currentColor" />
        <path
          d="M9.5 9.81055V12C9.5 13.3807 10.6193 14.5 12 14.5C12.6112 14.5 13.1702 14.2793 13.6045 13.915L14.668 14.9785C13.96 15.6131 13.0255 16 12 16C9.85996 16 8.11211 14.3194 8.00488 12.2061L8 12V8.31055L9.5 9.81055Z"
          fill="currentColor"
        />
        <path
          d="M12 2C14.2091 2 16 3.79086 16 6V12C16 12.2427 15.977 12.4801 15.9355 12.7109L14.5 11.2754V6C14.5 4.61929 13.3807 3.5 12 3.5C10.6193 3.5 9.5 4.61929 9.5 6V6.27539L8.14746 4.92285C8.61782 3.237 10.1641 2 12 2Z"
          fill="currentColor"
        />
        <path
          d="M5.5 12C5.5 15.5899 8.41015 18.5 12 18.5C13.7159 18.5 15.2748 17.8333 16.4365 16.7471L17.4971 17.8076C16.0635 19.165 14.1301 20 12 20C7.58172 20 4 16.4183 4 12H5.5Z"
